...
sudo wget  https://dlcdn.apache.org/tomcat/tomcat-9/v9.0.94/bin/apache-tomcat-9.0.94.tar.gz
sudo tar -xvf apache-tomcat-9.0.94.tar.gz
sudo rm -rf apache-tomcat-9.0.94.tar.gz
